...
#### 5-7. dnn_detect의 한계
  * 여러 물체를 한 다른 물체로 인식 커다란 물체로 인식하여 회피 기동하는 문제
     ...
     <img src="/image/labeling error_sofa.png" width="50%" height="50"></img>
     <img src="/image/labeling error_boat.png" width="50%" height="50%"></img>
     <img src="/image/labeling error_aeroplane.png" width="50%" height="50%"></img>
