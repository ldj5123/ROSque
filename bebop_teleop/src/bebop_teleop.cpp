...
int main(int argc, char** argv)
{
    ...
    while(ros::ok())
    {
        ...
        if(input_data == 32){      // 1이 입력된경우
            ...
            move_msg.linear.x = 0.2;    move_msg.linear.y = 0;  move_msg.linear.z = 0;
            ...
            geometry_msgs::Twist move_msg;
            move_msg.linear.x = 0;  move_msg.linear.y = 0.2;  move_msg.linear.z = 0;
            move_msg.angular.x = 0; move_msg.angular.y = 0; move_msg.angular.z = 0;
            ...
            move_msg.angular.x = 0; move_msg.angular.y = 0; move_msg.angular.z = 0.1;
            ...
            move_pub.publish(move_msg);
        } else if (input_data == 114 ) { // r이 입력된 경우, Emergency mode
